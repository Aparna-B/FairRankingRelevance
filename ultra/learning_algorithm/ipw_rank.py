...
class IPWrank(BaseAlgorithm):
    ...
    * Thorsten Joachims, Adith Swaminathan, Tobias Schnahel. 2017. Unbiased Learning-to-Rank with Biased Feedback. In Proceedings of WSDM '17
    ...
    def validation(self, input_feed, is_online_simulation= False, return_unpadded=False):
        ...
        print('Pad removed output shape: ',self.labels.shape)
        if return_unpadded:
            return None, self.output, self.eval_summary,  pad_removed_output# loss, outputs, summary.
        else:
